...
public class myAccoutPage {
	...
	By loc_btnDresses=By.xpath("//body/div[@id='page']/div[@class='header-container']/header[@id='header']/div/div[@class='container']/div[@class='row']/div[@id='block_top_menu']/ul[@class='sf-menu clearfix menu-content sf-js-enabled sf-arrows']/li[3]/a[1]");

	
	public void ClickDressesInTab() {
		Assert.assertTrue(objBaseTest.getObjSeleniumWrapperFunctions().click(loc_btnDresses));
