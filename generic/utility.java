...
public class utility {
	...
	//Random ToCity
		...
		public static String getRandomAdult() {
			Random Adult = new Random();
			int intMaxDay = 9;
			int intMinDay = 1;
			int rand_Day = Adult.nextInt(intMaxDay - intMinDay) + intMinDay;
			String strDate=Integer.toString(rand_Day);
			return strDate;

		}

		public static String getRandomChildren() {
			Random Adult = new Random();
			int intMaxDay = 8;
			int intMinDay = 1;
			int rand_Day = Adult.nextInt(intMaxDay - intMinDay) + intMinDay;
		...
		public static String getRandomInfants() {
			Random Adult = new Random();
			int intMaxDay = 1;
			int intMinDay = 0;
			int rand_Day = Adult.nextInt(intMaxDay - intMinDay) + intMinDay;
