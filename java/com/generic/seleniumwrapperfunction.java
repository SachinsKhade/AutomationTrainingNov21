...
public class seleniumwrapperfunction {
	...
	public static WebElement setExplicitlyWait(By locator) {
		objBaseTest.getDriver();
		{
			...
			try {
				webElement = new WebDriverWait(objBaseTest.getDriver(), 10, 20)
	...
	public boolean fluentWait(By locator) {
		...
		try {
			Wait<WebDriver> objWait = new FluentWait<WebDriver>(objBaseTest.getDriver())
					...
					.withMessage("Your desired element is not found").ignoring(NoSuchElementException.class);
    ...
    {		
        ...
        JavascriptExecutor excecutor = (JavascriptExecutor) objBaseTest.getDriver();  
        //Vertical scroll down by 600  pixels		
        excecutor.executeScript("window.scrollBy(0,600)");			
    }	
