...
public class utility {
		...
		//Random number 
			...
			public String generate_UserNmae()
			{
			...
			public static void captureScreenShort(WebDriver driver, String screenShotName)
			
			{
				try
				{
					...
					FileUtils.copyFile(source, new File("./AllImages/"+screenShotName+".png"));
					System.out.println("Hey ScreenShort Taken");
				}
				catch(Exception e)
				{
					System.out.println("Exception While taking sc"+e.getMessage());
				}
			}
